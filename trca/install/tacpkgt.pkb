...
/* $Header: 224270.1 tacpkgt.pkb 11.4.5.3 2012/12/31 carlos.sierra $ */
  ...
  /* -------------------------
   *
   * private purge_trca$_dict_gtt
   *
   * purges tool data dictionary global temporary tables
   *
   * ------------------------- */
  PROCEDURE purge_trca$_dict_gtt
  IS
  BEGIN /* purge_trca$_dict_gtt */
    put_line('-> purge_trca$_dict_gtt');
