Rem Copyright (c) 1990, 1996 by Oracle Corporation
Rem NAME
REM    UTLSAMPL.SQL
Rem  FUNCTION
Rem  NOTES
...
Rem
rem 
rem $Header: utlsampl.sql 06-aug-96.10:59:20 akolk Exp $ sqlbld.sql 
rem 
SET TERMOUT OFF
SET ECHO OFF
...
rem The following "CONNECT" will fail the first time we run this file
rem ... as will the "DROP" immediately following it ...
CONNECT FORD/CAR@homolog2
DROP TABLE PARTS;
CONNECT SYSTEM/MANAGER@homolog2
REVOKE CONNECT FROM FORD;
CONNECT SCOTT/TIGER@homolog2
DROP TABLE DEPT;
CREATE TABLE DEPT
