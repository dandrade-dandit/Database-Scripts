--NOME DO PROGRAMA: lock_objname.sql
--FINALIDADE: Detecta os bloqueios do banco de dados. Relaciona o usuário que
--		mantém o bloqueio, o objeto bloqueado e o tipo de bloqueio.
--USO: SQL>@lock_objname.sql
