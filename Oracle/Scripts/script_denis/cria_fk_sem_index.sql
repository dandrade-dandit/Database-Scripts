...
set long 32767;
 ...
 ACCEPT tablespace PROMPT 'DIGITE O TABLESPACE: '
 set echo on
 ACCEPT OK
 set echo off
 ...
 spool C:\Sistemas\Sql\Infraero\Oracle\Scripts\script_denis\cria_fk_sem_index_&dono..sql
...
--      Pesquisa as colunas
        begin
          ...
          close c2;
          dbms_output.put_line (')');
          dbms_output.put_line ('Tablespace &tablespace ;');
        end;
 END LOOP;
 CLOSE C1;
 END;
