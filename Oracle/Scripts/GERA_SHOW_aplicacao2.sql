...
set long 32767;
 ...
 spool c:\ronei\scripts\SHOW_&dono..tmp
...
spool c:\ronei\scripts\SHOW_&dono..txt;
begin
  dbms_output.put_line ('*****************************************************************************************');
...
@c:\ronei\scripts\SHOW_&dono..tmp
set echo off;
...
DECLARE
 ...
 my_prv      all_tab_privs.privilege%type;
 my_rol      all_tab_privs.grantee%type;
