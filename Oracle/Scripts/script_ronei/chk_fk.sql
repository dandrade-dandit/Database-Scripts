...
-- parametrização necessaria
 ...
 spool C:\Sistemas\Sql\Infraero\Oracle\Scripts\script_ronei\chk_fk_&tabe..sql

 SELECT 'SET ECHO ON' FROM DUAL;
 SELECT 'SET FEEDBACK ON' FROM DUAL;
 SELECT 'SPOOL C:\Sistemas\Sql\Infraero\Oracle\Scripts\script_ronei\CHK_FK_&tabe..lst' FROM DUAL;
