...
-- parametrização necessaria
 ...
 spool F:\DENIS\scripts\&dono._01not_found.sql
-- confere existência das tabelas 
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._02refer.sql
-- gera comando para habilitar grant references  
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._03tab.sql
-- gera comando para criação e inserção dos dados em uma tabela auxiliar 
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._04pk.sql
...
/
 spool off
/
 spool F:\DENIS\scripts\&dono._05fk.sql
...
/
 spool off
/
 spool F:\DENIS\scripts\&dono._06uk.sql
...
/
 spool off
/
 spool F:\DENIS\scripts\&dono._07ck.sql
-- gera comando para criação das constraints check
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._08ind.sql
...
/
 spool off
/
 spool F:\DENIS\scripts\&dono._09rebu_ind.sql
...
/
 ...
 set maxdata 60000;
 set long 32767;
spool F:\DENIS\scripts\&dono._10viw.sql
 -- gera views
 select ' ' from dual;
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._11fun.sql
 -- gera functions
 select ' ' from dual;
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._12pkg.sql
 -- gera package
 select ' ' from dual;
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._13pkb.sql
 -- gera PACKAGE_BODY
 select ' ' from dual;
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._14pro.sql
 -- gera Procedure
 select ' ' from dual;
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._15trg.sql
 -- gera triggers
 select ' ' from dual;
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._16seq.sql
 -- gera sequences
 select ' ' from dual;
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._17syn.sql
-- gera comando para criação do sinonimo
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._18role.sql
-- gera comando para criação das roles
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._19priv.sql
...
--
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._21trunc.sql
-- gera comando para deletar os dados das tabelas 
 ...
 spool off
/
 spool F:\DENIS\scripts\&dono._22carga.sql
