...
REM |--------------------------------------------------------------------------|
REM |    Copyright (c) 1998-2009 Jeffrey M. Hunter. All rights reserved.       |
REM |--------------------------------------------------------------------------|
REM | FILE       : rman_copy_purge_backupset_9i.bat                            |
...
REM | USAGE      :                                                             |
REM |                                                                          |
REM | rman_copy_purge_backupset_9i.bat "SOURCE_DIR"  "DEST_DIR"  "DAYS_OLD"    |
REM |                                                                          |
...
set FILENAME=rman_copy_purge_backupset_9i
set SOURCE_DIR=%1%
set DEST_DIR=%2%
set DAYS_OLD=%3%
...
:USAGE
echo Usage:  rman_copy_purge_backupset_9i.bat  SOURCE_DIR  DEST_DIR  DAYS_OLD
