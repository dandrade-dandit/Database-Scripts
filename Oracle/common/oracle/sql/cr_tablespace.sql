...
-- |----------------------------------------------------------------------------|
-- | DATABASE : Oracle                                                          |
-- | FILE     : cr_tablespaces.sql                                              |
-- | CLASS    : Create Object Examples                                          |
-- | PURPOSE  : Example SQL script that demonstrates how to create several types|
-- |            of tablespaces in Oracle7 - 9i.                                 |
...
CREATE TABLESPACE users
  LOGGING DATAFILE '/u10/app/oradata/ORA920/users01.dbf' SIZE 10M REUSE
