...
-- |----------------------------------------------------------------------------|
-- | DATABASE : Oracle                                                          |
-- | FILE     : dba_snapshot_database.sql                                       |
...
-- | VERSION  : This script was designed for Oracle Database 10g Release 2 and  |
-- |            higher.                                                         |
-- | USAGE    :                                                                 |
-- |                                                                            |
-- |    sqlplus -s <dba>/<password>@<TNS string> @dba_snapshot_database.sql     |
-- |                                                                            |
...
prompt
prompt +-----------------------------------------------------------------------------------------+
prompt |                                    Snapshot Database                                    |
prompt |-----------------------------------------------------------------------------------------+
prompt | Copyright (c) 1998-2019 Jeffrey M. Hunter. All rights reserved. (www.idevelopment.info) |
prompt +-----------------------------------------------------------------------------------------+
prompt
...
define reportHeader="<font size=+3 color=darkgreen><b>Snapshot Database</b></font><hr>Copyright (c) 1998-2019 Jeffrey M. Hunter. All rights reserved. (<a target=""_blank"" href=""http://www.idevelopment.info"">www.idevelopment.info</a>)<p>"
...
define fileName=dba_snapshot_database
