...
SPOOL tacdiri2.log;
REM $Header: 224270.1 tacdiri2.sql 11.4.5.0 2012/11/21 carlos.sierra $
REM
...
REM   3. Execute script tacdiri2.sql
REM
REM EXAMPLE
REM   # cd trca/utl
REM   # sqlplus /nolog
REM   SQL> connect / as sysdba
REM   SQL> start tacdiri2.sql [full input directory path]
REM   SQL> start tacdiri2.sql /home/csierra/traces
REM
REM NOTES
REM   1. For possible errors see tacdiri2.log file
REM
-- begin common
...
CREATE OR REPLACE DIRECTORY TRCA$INPUT2 AS '&&directory_path.';

GRANT READ,WRITE ON DIRECTORY TRCA$INPUT2 TO trcadmin;
