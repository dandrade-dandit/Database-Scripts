...
-- Generated 2-dez-2004 20:31:19 from SYSMAN@HOMOLOG2

CREATE OR REPLACE 
PROCEDURE ifrbde.prc_remanejamento_automatico (
      ...
      THEN
         ...
         INSERT INTO ifrbde.tab_rec_aprovado
                     (rap_cre_cod, rap_rti_cod, rap_pgose, rap_valor,
                      rap_cre_pgi, num_seq_carencia_rec)
              VALUES (z.rap_cre_cod, p_cod_destino, z.rap_pgose, 0.00,
                      'F', v_num_seq_carencia_rec);
      END IF;


--
      SELECT ifrbde.seq_rmj_cod.NEXTVAL
        INTO v_rmj_cod
        FROM DUAL;
...
GRANT EXECUTE ON ifrbde.prc_remanejamento_automatico TO bde_geral
/
