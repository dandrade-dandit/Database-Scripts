...
Procedure CARREGAR_TMP_ABSENTEISMO
   (p_usuario       IN VARCHAR2,
    p_dsp_cod_cn    IN NUMBER,
    p_dsp_cod_dep   IN NUMBER,
  ...
  loop
    ...
    INSERT INTO TMP_ABSENTEISMO
         (
          ...
          ofu_codigo,
          sigla_cargo_atual,
          descricao_ocupacao_atual,
          descricao_funcao_atual
         )
       VALUES
         (
          p_usuario,
          ...
          r_dep.Tipo_exp,
          r_dep.cid_codigo,
          r_dep.especificacao_CID,
          r_dep.data_nascimento,
          r_dep.nro_identidade,
          r_dep.data_expedicao_CI,
          r_dep.ofu_codigo,
          r_dep.sigla_cargo_atual,
          r_dep.descricao_ocupacao_atual,
          r_dep.descricao_funcao_atual
         );
  --
  end loop;
  --
...
-- End of DDL script for CARREGAR_TMP_ABSENTEISMO
