...
AS
   servidor       VARCHAR2 (100)      := '10.0.17.47'; -- pode ser utilizado o 10.0.17.29 também.
...
BEGIN
   ...
   UTL_SMTP.write_data (conexao_smtp, UTL_TCP.crlf || UTL_TCP.crlf || mensagem); --  Envia o corpo do email, isto é, a
