...
rem   
rem  ==========================================================================
rem  Modified 15-Aug-2000: html format
rem  Modified 31-Dec-2000: smaller fonts
rem  Modified 02-Aug-2001: added table which shows a too high or low growth rate 
rem  Modified 07-Apr-2002: order by S.owner,S.segment_type,S.bytes 
rem  ==========================================================================
...
prompt <p> <font face="Verdana" size=2>
...
break on C1
select '<tr align=right><td align=center>','<font face="Verdana" color=steelblue size=2>'||
        initcap(substr(S.owner,1,10))||'<tr align=right><td>' C1
      ,'<td>'||initcap(S.segment_type)
...
/
prompt <tr bgcolor="#EFEFEF"><td colspan=9> <b> Growth rate > 45% (too high) </b>
...
from   sys.DBA_SEGMENTS S
where  S.owner not in ('SYS','SYSTEM')
and    (next_extent/S.bytes)*100 >= 45
and    extents >= 2
order by S.owner,S.segment_type,S.bytes desc
/
