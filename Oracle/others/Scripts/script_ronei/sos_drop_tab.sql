...
-- parametrização necessaria
 ...
 spool C:\Sistemas\Sql\Infraero\Oracle\Scripts\script_ronei\sos_drop_&tabe..sql
...
BEGIN 
 OPEN C1;
 virg := ' ';
 dbms_output.put_line ('CREATE TABLE &dono..&tabe ('); 
 LOOP
     fetch c1 into my_col,my_typ,my_len,my_pre,my_sca;
     exit when c1%notfound;
     dbms_output.put (virg); 
