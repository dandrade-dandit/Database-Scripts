...
-- parametrização necessaria
 ...
 spool C:\Sistemas\Sql\Infraero\Oracle\Scripts\script_ronei\cria_LOG_&tabe..sql
 ...
 select 'create table &dono..LOG_&tabe as                        ',
        'select * from &dono..&tabe where rowid is null;' from dual;
 ...
 from dual;
 select 'alter table &dono..LOG_&tabe add estacao varchar2(30);'
 from dual; 
 select 'alter table &dono..LOG_&tabe add conta_rede varchar2(30);'
 from dual; 
...
BEGIN 
 ...
 dbms_output.put_line ('USER_MACHINE VARCHAR(30);');
 dbms_output.put_line ('OS_USER VARCHAR(30);');
 dbms_output.put_line ('BEGIN');
 dbms_output.put_line ('SELECT 	SYS_CONTEXT (''USERENV'', ''HOST'')  USER_MACHINE');
 dbms_output.put_line (',	SYS_CONTEXT (''USERENV'', ''OS_USER'')  OS_USER');
 dbms_output.put_line ('INTO   	USER_MACHINE, OS_USER');
 ...
 dbms_output.put_line (',estacao'); 
 dbms_output.put_line (',conta_rede'); 
 ...
 dbms_output.put_line (',user_machine'); 
 dbms_output.put_line (',os_user'); 
 dbms_output.put_line (');');
