...
target='target /'
catalog='rcvcat rman_homolog/rman@rman_catalog' # force user to supply catalog option
...
delete_log=/u02/backup/log/deleted.log;      # execution log from generated script
