...
ORACLE_SID=case9i
TARGET_INIT_FILE=/u01/app/oracle/product/10.1/dbs/orapwcase9i
RMAN_LOG_FILE=/u02/backup/log/rman_incr1_case9i.log
TARGET_CONNECT_STR=/
CATALOG_CONNECT_STR=rman_case9i/rman@rman_catalog2
