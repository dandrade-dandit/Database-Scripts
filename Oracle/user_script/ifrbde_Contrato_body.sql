/* Formatted on 2003/07/03 11:51 (Formatter Plus v4.5.2) */
   ...
   BEGIN
      ...
      THEN
         SELECT num_seq_contrato, cnt_cre_cod, cnt_cod,
                ...
                TO_CHAR (cnt_data, 'dd/mm/yyyy'),
                TO_CHAR (cnt_data_proposta, 'dd/mm/yyyy'),
                TO_CHAR (cnt_data_inicio, 'dd/mm/yyyy'), cnt_prazo_exec,
                num_prazo_exec_meses, cnt_prazo_adit,
                TO_CHAR (dat_termino_contrato, 'dd/mm/yyyy'),
                ifrbde_views.pck_geral.stf_cur2str (cnt_valor_compromisso),
                ifrbde_views.pck_geral.stf_cur2str (cnt_valor_termo),
                ifrbde_views.pck_geral.stf_cur2str (cnt_valor_pago),
                ifrbde_views.pck_geral.stf_cur2str (cnt_valor_reaj),
                ifrbde_views.pck_geral.stf_cur2str (cnt_valor_reaj_pago),
                ifrbde_views.pck_geral.stf_cur2str (cnt_valor),
...
--         
            ...
            EXCEPTION
               ...
               THEN
                  raise_application_error (
                     -20100,
                        ' Erro no Nº do Ato Administrativo '
                     || SQLERRM
                  );
            END;
...
--         
            ...
            EXCEPTION
               ...
               THEN
                  raise_application_error (
                     -20100,
                        ' Erro data inicio vigencia do contrato '
                     || SQLERRM
                  );
            END;
...
--         
            ...
            EXCEPTION
               ...
               THEN
                  raise_application_error (
                     -20100,
                        ' Erro no nome da primeira assinatura '
                     || SQLERRM
                  );
            END;
...
--         
            ...
            EXCEPTION
               ...
               THEN
                  raise_application_error (
                     -20100,
                        ' Erro no nome da segunda assinatura '
                     || SQLERRM
                  );
            END;
...
--         
            ...
            EXCEPTION
               ...
               THEN
                  raise_application_error (
                     -20100,
                        ' Erro no prazo de execução (dias) '
                     || SQLERRM
                  );
            END;
...
--         
            ...
            EXCEPTION
               ...
               THEN
                  raise_application_error (
                     -20100,
                        ' Erro no prazo de execução (meses) '
                     || SQLERRM
                  );
            END;
