/* Formatted on 2003/04/23 16:05 (Formatter Plus v4.5.2) */
...
--------------------------------------------------------------------
 ...
 -- retorna o recordset correspondente
   ...
   BEGIN
      ...
      THEN
         SELECT num_seq_termo, num_seq_contrato_termo,
                cta_periodo, cta_num, cta_objeto,
                cta_valor, cta_deb_cred, cta_prazo,
                cta_aum_dim
           INTO vo_num_seq_termo (1), vo_num_seq_contrato_termo (1),
                vo_cta_periodo (1), vo_cta_num (1), vo_cta_objeto (1),
                vo_cta_valor (1), vo_cta_deb_cred (1), vo_cta_prazo (1),
                vo_cta_aum_dim (1)
           FROM ifrbde_views.tab_cont_termo_aditivo
          WHERE num_seq_termo = vi_num_seq_termo
            AND num_seq_contrato_termo = vi_num_seq_contrato_termo;
      END IF;
   EXCEPTION
      WHEN OTHERS
      THEN
      ...
      THEN
         ...
         THEN
            ...
            ifrbde_views.pck_seguranca.stp_log (
               ...
               || TO_CHAR (vi_num_seq_contrato_termo)
            );
            COMMIT;
         ELSIF SQL%ROWCOUNT > 1
         THEN
   ...
   BEGIN
      ...
      THEN
         ...
         INSERT INTO ifrbde_views.tab_cont_termo_aditivo
                     (num_seq_termo, num_seq_contrato_termo,
                      cta_periodo, cta_num, cta_objeto, cta_valor,
                      cta_deb_cred, cta_prazo, cta_aum_dim)
              VALUES (v_num_seq_termo, v_num_seq_contrato_termo,
                      v_cta_periodo, v_cta_num, v_cta_objeto, v_cta_valor,
                      v_cta_deb_cred, v_cta_prazo, v_cta_aum_dim);
...
-- retorna o recordset correspondente
   ...
   AS
      ...
      v_num_seq_contrato_termo   ifrbde_views.tab_cont_termo_aditivo.num_seq_contrato_termo%TYPE;
...
-- retorna o recordset correspondente
   PROCEDURE stp_pesquisa_contrato (
      ...
      vo_num_contrato_original    OUT      tyt_num_contrato_original,
      ...
      THEN
         SELECT num_seq_contrato, cnt_cre_cod, cnt_cod,
           ...
           INTO vo_num_seq_contrato (1), vo_cnt_cre_cod (1), vo_cnt_cod (1),
                vo_num_contrato_original (1), vo_cod_dep_contrato (1),
                ...
                vo_cnt_crea (1), vo_cnt_ice_cod (1), vo_cnt_data (1),
      ...
      THEN
         ...
         INSERT INTO ifrbde_views.tab_contrato
                     (num_seq_contrato, cnt_cre_cod, cnt_cod,
                      cnt_justificativa_cre, num_seq_gestor,
                      num_seq_assinatura_1, num_seq_assinatura_2,
                      num_ato_administrativo, cnt_cei, cnt_crea,
                      cnt_ice_cod, cnt_data, cnt_data_proposta,
              ...
              VALUES (v_num_seq_contrato, v_cnt_cre_cod, v_cnt_cod,
                      v_cnt_justificativa_cre, v_num_seq_gestor,
                      v_num_seq_assinatura_1, v_num_seq_assinatura_2,
                      v_num_ato_administrativo, v_cnt_cei, v_cnt_crea,
                      v_cnt_ice_cod, v_cnt_data, v_cnt_data_proposta,
                      v_cnt_data_inicio, v_cnt_prazo_exec,
                      v_num_prazo_exec_meses, v_tip_situacao_contrato);
   ...
   BEGIN
      ...
      THEN
         SELECT num_seq_contrato_res_rv, num_seq_resumo_rv,
                ...
                val_resumo_rv, val_termo_rv,
                val_pagamento_rv, val_reajuste_rv,
                val_pago_rv, val_pago_reajuste_rv,
                val_saldo_resumo_rv, flg_moeda_controle_rv,
                tip_moeda_rv, dat_moeda_rv,
                val_cotacao_moeda_rv, tip_cotacao_moeda_rv,
                val_resumo_sec_rv, val_termo_sec_rv,
                val_pagamento_sec_rv, val_reajuste_sec_rv,
                val_pago_sec_rv, val_pago_reajuste_sec_rv,
                val_saldo_resumo_sec_rv
           INTO vo_num_seq_contrato_res_rv (1), vo_num_seq_resumo_rv (1),
                vo_cnt_cre_cod_res (1), vo_cnt_cod_res (1),
                vo_val_resumo_rv (1), vo_val_termo_rv (1),
                vo_val_pagamento_rv (1), vo_val_reajuste_rv (1),
                vo_val_pago_rv (1), vo_val_pago_reajuste_rv (1),
                vo_val_saldo_resumo_rv (1), vo_flg_moeda_controle_rv (1),
                vo_tip_moeda_rv (1), vo_dat_moeda_rv (1),
                vo_val_cotacao_moeda_rv (1), vo_tip_cotacao_moeda_rv (1),
                vo_val_resumo_sec_rv (1), vo_val_termo_sec_rv (1),
                vo_val_pagamento_sec_rv (1), vo_val_reajuste_sec_rv (1),
                vo_val_pago_sec_rv (1), vo_val_pago_reajuste_sec_rv (1),
