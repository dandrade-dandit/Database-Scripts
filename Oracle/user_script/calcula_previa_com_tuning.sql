...
--     (1390,1340,1345,5090,5098,5085,5095,5060,5510,5525,5105)
    (5350,5105,1340,1345,5060,5090,5095,5098,5085,
  ...
  if r_mov.mov_mes_referencia = 12 then
     if r_mov.mov_rub_codigo in (5100,5110,5115) then
        Obtem_valor_irrf;
     end if;
  else
...
Begin
   ...
   if par_matricula is null then
      ...
      if par_mes_calculo = 12 and par_versao = 1 then
         ...
         and    mov_rub_codigo in (5350,5105,1340,1345,5060,5090,5095,5098,5085,
                                   5510,5525,5092,5094,1925,1926,1945,1342,
                                   5934,5935,5902,1295);
         --
         commit;
