-- Start of DDL Script for Package Body IFRSIVNET.VOO_TOTEM_V3
-- Generated 11-mai-2005 9:41:31 from IFRSIVNET@INET

-- Drop the old instance of VOO_TOTEM_V3
DROP PACKAGE BODY ifrsivnet.voo_totem_v3
/

CREATE OR REPLACE 
package body                     ifrsivnet.voo_totem_v3 is
...
htp.print( ' <FORM action="voo_totem_v3.ini" method="GET" class="input"
name="cidade">
...
htp.print( ' </td></form>
  <FORM action="voo_totem_v3.ini" method="GET" name="opcao">
...
<!-- Logo INFRAERO -->
<td bgcolor="#0e3463" width="40%">
  <img width="210" height="40" border="0"
    src="http://www.infraero.gov.br/sivnet/img/logo_sivnet.jpg"   >
</td>
...
htp.print( '</td>
<!-- Links do SivNet -->
<td bgcolor="#0e3463" width="20%" >
 <p align="right">
  <a href="javascript:history.back();">
   <img border="0"
     src="http://www.infraero.gov.br/sivnet/img/voltar.jpg"
     alt="Voltar" width="40" height="40">
  </a>
...
-->
  ...
  <a href="javascript:totem_fecha();">
   <img border="0"
     src="http://www.infraero.gov.br/sivnet/img/fechar.jpg"
     alt="Fechar" width="40" height="40">
  </a>
 </p>
</td></tr></table>');
END SIV_BANNER;
...
<table width="770" border="0" cellspacing="0"  height="15" cellpadding="0"
                                                         bgcolor="#efefef">
  <tr valign="top" >
    <td width="877" bgcolor="#efefef" > <!-- coluna apenas para sintaxe da table abaixo -->
 <form action="voo_totem_v3.ini" method="GET" name="filtro_cia" target="_self">
 <table width="876" border="0" align="left" cellpadding="0" cellspacing="0"                                              class="tab2" >
 <tr valign="middle" >
          <td width="73" align="right" >
 <font class="Titulo" >Filtro&nbsp;</font>
          </td>
          <td width="620" align=left height="30"
                         valign="middle" bgcolor="#efefef" >
       <table width="600" cellspacing=0 cellpadding=2 border=0 class="tab3">
...
htp.print(' </SELECT>
 ...
 <td width="240" valign="middle" bgcolor="#CCCCCC" >
<font class="Titulo2" >&nbsp;
...
<form action="voo_totem_v3.ini" method="GET" name="filtro_num" target="_self" >
...
<tr><td style="font-family: verdana; font-size: 9pt;"> '||reg_texto.texto||'</td></tr></table>');
...
GRANT EXECUTE ON ifrsivnet.voo_totem_v3 TO sivnet_geral
/


-- End of DDL Script for Package Body IFRSIVNET.VOO_TOTEM_V3
